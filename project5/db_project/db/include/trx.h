...
std::pair<int,int> is_conflict_lock_in_record_lock_list(lock_t* pred_same_rid_lock_obj, int64_t table_id, pagenum_t page_id, int trx_id, int64_t record_id, int lock_mode, int record_index);
